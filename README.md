...
- **Core Theme**: *"Understanding how things work"* — bridging ~3 years of production enterprise backend engineering (PKI, Spring Boot, Kubernetes) with foundational machine learning, PyTorch, and applied GenAI.
...
## 📝 Where to Edit Content & Update Information
...
### 1. Social & Contact Info
- **LinkedIn**: Linked to `https://www.linkedin.com/in/aashish-s-a-27365621a/`.
- **GitHub**: Linked to `https://github.com/AashishStark`.
...
### 3. Research Papers
- **Paper 1 (Plant Pathology)**: Linked to `https://github.com/AashishStark/Plant-Disease-with-Inception-v3-Alexnet-CNN`.
- **Paper 2 (Vehicle Pollution Detection)**: Linked to `https://github.com/AashishStark/Vehicle-Pollution-Detection`.
